...
public class Sort_Basic_Sequence {
    public static void main(String[] args) throws Exception {
        Configuration configuration = new Configuration();
        Job job = new Job(configuration, "Basic_Sort");
        job.setJarByClass(Sort_Basic_Sequence.class);

        job.setMapperClass(Sort_Basic_Sequence.mapper.class);
        job.setMapOutputKeyClass(IntWritable.class);
        job.setMapOutputValueClass(IntWritable.class);
        job.setReducerClass(Reducer.class);
        job.setOutputKeyClass(IntWritable.class);
        job.setOutputValueClass(IntWritable.class);
        job.setPartitionerClass(Sort_Basic_Sequence.WordPartitioner.class);
